...
function App() {
  ...
  return (
    <div className='container' style={{height: 'unsets', width: '100vw'}}>
      <div className='container1' style={{height: '50vh'}}></div>
      <div className='container2' style={{height: '100vh'}}>
        <div className="box" style={{width: '150px', height: '150px', marginBlock: '50px '}}>
          <img src={'https://th.bing.com/th/id/OIP.2odbmslqbAwDbfyN77mukgHaHa?rs=1&pid=ImgDetMain'} style={{width: '100%', height: '100%'}} />
        </div>
